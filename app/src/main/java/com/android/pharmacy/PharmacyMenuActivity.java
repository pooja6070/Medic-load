...
import com.android.pharmacy.adapters.MenuListAdapter;
...
public class PharmacyMenuActivity extends AppCompatActivity implements MenuListAdapter.MenuListClickListener {
        ...
        buttonCheckout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(itemsInCartList != null && itemsInCartList.size() <= 0) {
                    Toast.makeText(PharmacyMenuActivity.this, "Please add some items in cart.", Toast.LENGTH_SHORT).show();
                    return;
                }
                pharmacyModel.setMenus(itemsInCartList);
                Intent i = new Intent(PharmacyMenuActivity.this, PlaceYourOrderActivity.class);
